...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get started with Vivid"),
		description: localize('gettingStarted.setup.description', "Set up your editor and build something with the agent"),
		isFeatured: true,
		icon: setupIcon,
		when: '!isWeb',
		walkthroughPageTitle: localize('gettingStarted.setup.walkthroughPageTitle', 'Set up Vivid'),
		next: 'Beginner',
		content: {
			type: 'steps',
			steps: [
	...
	{
		id: 'SetupWeb',
		title: localize('gettingStarted.setupWeb.title', "Get started with Vivid for the Web"),
